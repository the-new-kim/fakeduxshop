...
const glook = Gloock({
  ...
  // subsets?: ("cyrillic-ext" | ... 1 more ... | "latin-ext")[] | undefined;
});
...
const H1 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h1
      className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl ${glook.className}  ${className}`}
    >
      {children}
    </h1>
  );
...
const H2 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h2
      className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl ${glook.className}  ${className}`}
    >
      {children}
    </h2>
  );
...
const H3 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h3
      className={`text-lg sm:text-xl md:text-2xl lg:text-3xl ${glook.className}  ${className}`}
    >
      {children}
    </h3>
  );
...
const H4 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h4
      className={`text-base sm:text-lg md:text-xl lg:text-2xl ${glook.className}  ${className}`}
    >
      {children}
    </h4>
  );
...
const H5 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h5
      className={`text-sm sm:text-base md:text-lg lg:text-xl ${glook.className}  ${className}`}
    >
      {children}
    </h5>
  );
